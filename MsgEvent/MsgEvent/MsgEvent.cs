...
namespace MsgEvent
{
    ...
    public partial class MsgEvent : Form
    {
        //定义事件对象
        ...
        private void ToSendMessage(string msg)
        {
            ...
            IntPtr WINDOW_HANDLER = FindWindow(null, "MsgRev");
        ...
        private void uibtnSend_Click(object sender, EventArgs e)
        {
            string str = uitbxSend.Text;
        ...
        private void uibtnEvent_Click(object sender, EventArgs e)
        {
            string str = uitbxSend.Text;
